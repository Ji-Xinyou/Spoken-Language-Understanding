...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--model', default='baseline', help='model')
    arg_parser.add_argument('--tr_filename', default='train.json', help='train data')
    arg_parser.add_argument('--berttype', default='bert-base-chinese', help='the type of bert')
    ...
    arg_parser.add_argument('--encoder_cell', default='LSTM', choices=['LSTM', 'GRU', 'RNN'], help='encoder/decoder cell struct of the model')
